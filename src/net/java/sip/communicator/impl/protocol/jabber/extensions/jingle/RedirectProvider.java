    ...
    implements PacketExtensionProvider
{
    ...
    /**
     * Returns the content of the next {@link org.xmlpull.v1.XmlPullParser#TEXT} element that
     * we encounter in <tt>parser</tt>.
     *
     * @param parser the parse that we'll be probing for text.
     *
     * @return the content of the next {@link org.xmlpull.v1.XmlPullParser#TEXT} element we
