...
public class JingleUtils
{
    ...
    /**
     * Extracts and returns an {@link net.java.sip.communicator.impl.protocol.jabber.extensions.jingle.RtpDescriptionPacketExtension} provided
     * with <tt>content</tt> or <tt>null</tt> if there is none.
     *
     * @param content the media content that we'd like to extract the
     * {@link net.java.sip.communicator.impl.protocol.jabber.extensions.jingle.RtpDescriptionPacketExtension} from.
     *
     * @return an {@link net.java.sip.communicator.impl.protocol.jabber.extensions.jingle.RtpDescriptionPacketExtension} provided with
     ...
     *
     * @param payloadType the {@link net.java.sip.communicator.impl.protocol.jabber.extensions.jingle.PayloadTypePacketExtension} which is to be
...
//    }
     ...
     *
     * @param desc the {@link net.java.sip.communicator.impl.protocol.jabber.extensions.jingle.RtpDescriptionPacketExtension} that we'd like to
...
//    }
     ...
     * {@link net.java.sip.communicator.impl.protocol.jabber.extensions.jingle.ContentPacketExtension.SendersEnum} value so that we could add it to a content element.
     ...
     * <p>
     * Example: A {@link org.jitsi.service.neomedia.MediaDirection#SENDONLY} value would be translated to
     * {@link net.java.sip.communicator.impl.protocol.jabber.extensions.jingle.ContentPacketExtension.SendersEnum#initiator} from the initiator's perspective and to
     * {@link net.java.sip.communicator.impl.protocol.jabber.extensions.jingle.ContentPacketExtension.SendersEnum#responder} otherwise.
     *
     * @param direction the {@link org.jitsi.service.neomedia.MediaDirection} that we'd like to translate.
     ...
     * {@link org.jitsi.service.neomedia.MediaDirection#SENDONLY} from the initiator's perspective and to
     * {@link org.jitsi.service.neomedia.MediaDirection#RECVONLY} from the responder's.
     *
     ...
     *
     * @param content the {@link net.java.sip.communicator.impl.protocol.jabber.extensions.jingle.ContentPacketExtension} that we'll be searching
     * for a component.
    ...
    /**
     * Creates a new {@link net.java.sip.communicator.impl.protocol.jabber.extensions.jingle.ContentPacketExtension} instance according to the
...
//     * {@link net.java.sip.communicator.impl.protocol.jabber.extensions.jingle.PayloadTypePacketExtension} instance.
//     *
